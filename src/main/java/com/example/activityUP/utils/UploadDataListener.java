...
@Slf4j
public class UploadDataListener implements ReadListener<SysActivity> {
     ...
     * 缓存的数据
     */
    private List<SysActivity> cachedDataList = ListUtils.newArrayListWithExpectedSize(BATCH_COUNT);
    /**
